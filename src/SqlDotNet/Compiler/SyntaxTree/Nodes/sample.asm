...
oresset res0 (A)	// Open/create a new result-set
filter cur0
{
...
{
	crow     		// Create a new row in the result-set 0
	lcol.cur0 A		// Load column value A to the stack
	pnxc					// Pop the value form the stack to the next column
}


//Statement: select func(1, 2)
oresset res0 (__col0)	// Open/create a new result-set
fresset.res0 ()		// Fill the result-set res0 using cursor cur0
{
	crow				// Create a new row in the result-set 0
	ldc.i4 1
	ldc.i4 2
